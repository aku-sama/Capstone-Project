...
public class PinSetActivity extends GeneralActivity<IPinSetView, PinSetPresenter, PinSetViewState> implements IPinSetView {
    ...
    @NonNull
    @Override
    public PinSetViewState createViewState() {
        return new PinSetViewState();
    }
    ...
    public void showPinSuccessDialog() {
        ...
        builder.setTitle(R.string.set_pin_title)
                .setMessage(R.string.set_pin_success_message)
